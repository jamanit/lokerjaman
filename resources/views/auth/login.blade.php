        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="card card-primary mt-5 radius-10">
                        <div class="card-header">
                            <a href="{{ url('/') }}">
                                <img src="{{ Storage::url($brand_profile->logo) }}" alt="logo" width="100">
                            </a>
                        ...
                        {{-- <div class="mb-4 text-muted text-center">
                            Belum memiliki akun? <a href="{{ url('register') }}">registrasi</a>
                        </div> --}}
                    </div>
