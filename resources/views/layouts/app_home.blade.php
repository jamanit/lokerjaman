...
<body class="layout-3 bg-gray">
    ...
    <button id="scrollUp" class="scroll-btn" style="display: none;"><i class="fas fa-chevron-up"></i></button>
    <button id="scrollDown" class="scroll-btn" style="display: none;"><i class="fas fa-chevron-down"></i></button>
